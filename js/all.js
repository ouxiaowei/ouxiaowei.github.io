		...
		this.each(function() {
			...
			var Old = {
				...
				doneResizing: function(){
					...
					var curr_opts = $self.data('http://www.jq22.com/demo/jqueryCyMoban201803051139/js/vendor/cycle.opts');
